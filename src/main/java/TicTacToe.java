public class TicTacToe {
     ...
     * @param sizeOfBoard The size of the length and width of the board
     * @param inline Required number of square in a row to win
     * @param max_levels the max level of the game tree
     */
    public TicTacToe (int sizeOfBoard, int inline, int max_levels) {

        // Create a new Game Board of size sizeOfBoard
        gameBoard = new char[sizeOfBoard][sizeOfBoard];
